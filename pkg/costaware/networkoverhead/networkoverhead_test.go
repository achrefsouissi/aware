...
func BenchmarkCustomNetworkOverheadPreFilter(b *testing.B) {
...
func TestCustomNetworkOverheadScore(t *testing.T) {
...
func BenchmarkCustomNetworkOverheadScore(b *testing.B) {
	// Get AppGroup CRD: onlineboutique
	onlineBoutiqueAppGroup := GetAppGroupCROnlineBoutique()
...
func TestCustomNetworkOverheadFilter(t *testing.T) {
...
func BenchmarkCustomNetworkOverheadFilter(b *testing.B) {
	// Get AppGroup CRD: onlineboutique
	onlineBoutiqueAppGroup := GetAppGroupCROnlineBoutique()
